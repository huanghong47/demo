...
public class DateTimeUtil {
	...
	public static final String DATETIME_FORMAT_07 = "yyyy-MM";
	/**
	 * 时间转换字符串
	 * @param date
	 * @param format
	...
	public static String date2String(Date date, String format){
		if (null == date || ParamUtil.isBlank(format))
			return null;
		try{
	...
	public static Date string2Date(String string, String format){
		if(ParamUtil.isBlank(string) || ParamUtil.isBlank(format)){
			return null;
		}
		try {
			SimpleDateFormat sdf = getSdf(format);
	...
	public static String getCurrentTime(){
		SimpleDateFormat sdf = getSdf(DATETIME_FORMAT_01);
	...
	private static SimpleDateFormat getSdf(final String pattern) {
	 ...
	 public static String getLastDayOfMonth2(String month) {     
         Calendar cal = Calendar.getInstance();     
         cal.set(Calendar.YEAR, Integer.valueOf(month.split("-")[0]));     
         cal.set(Calendar.MONTH, Integer.valueOf(month.split("-")[1])-1);     
         cal.set(Calendar.DAY_OF_MONTH,cal.getActualMaximum(Calendar.DATE));  
        return  new   SimpleDateFormat( "yyyy-MM-dd ").format(cal.getTime());  
     }   
     public static String getFirstDayOfMonth2(String month) {     
         Calendar cal = Calendar.getInstance();     
         cal.set(Calendar.YEAR, Integer.valueOf(month.split("-")[0]));     
         cal.set(Calendar.MONTH, Integer.valueOf(month.split("-")[1])-1);  
